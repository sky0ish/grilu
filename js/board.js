...
(function () {
  ...
  function boardName(code) {
    var m = { notice: '공지사항', news: '노조소식', statement: '성명서·보도자료', othernews: '기타 노조 소식', regulation: '규정 및 지침', council: '노사협의회',
      ...
      board: '조합원 자유게시판', staff: '운영진 게시판', delegate: '회의자료', director: '노동이사 활동보고', committee: '심의위원회', budget: '예산결산서', guide: '가이드라인', wish: '노조에 바란다', vote: '조합원 투표', audit: '행정사무감사', assembly: '경기도의회 회의록', photo: '사진자료', video: '동영상' };
    return m[code] || code;
  }
